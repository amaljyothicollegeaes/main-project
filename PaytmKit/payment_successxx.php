 ...
 <body style="background-color:#e8eff4">
     ...
     <center>
         <div style="background-color:white;margin-right:20%;margin-left:20%;border-radius: 5px;box-shadow: 1px 1px 5px 5px lightblue">
             <h1 style="color:white;background-color:blue;border-radius: 6px 6px 0px 0px">Payment Successfull</h1>
                 ...
                 <table style="border:none">
                     <tbody class="form-table">
                         ...
                         <tr>
                             <td></td>
                             <td></td>
                             <td><input value="Continue" type="submit" style="width:100px" onclick="" class="btn btn-primary"></td>
             ...
             <form method="post" action="../reportgen.php">



                 <input style="border:none" type="hidden" readonly id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?= $order_id  ?>">

                 <input type="hidden" style="border:none;" id="CUST_ID" tabindex="2" maxlength="15" size="15" name="CUST_ID" autocomplete="off" value="<?= $bank ?>">

                 <input type="hidden" style="border:none;width:100%" readonly id="INDUSTRY_TYPE_ID" tabindex="4" maxlength="12" size="12" name="INDUSTRY_TYPE_ID" autocomplete="off" value="<?= $month ?>">

                 <input type="hidden" style="border:none" title="TXN_AMOUNT" readonly tabindex="10" type="text" name="TXN_AMOUNT" value="<?= $amount ?>">

                 <input value="Print" style="margin-top:-40px;margin-right:-63px;width:100px" type="submit" onclick="" class="btn btn-primary"></td>
