        ...
        ?>
            <tbody>
              <tr>
                ...
                ?>
                <td>
                  <a href="view.php?id=<?= $row["id"] ?>" class="btn btn-outline-secondary" style="color:white" ;>View</a>
                </td>
                <?php
                ?>
                <td>
                  ...
                  <a href="confirm.php?id=<?= $row["id"] ?>" class="btn btn-outline-primary" style="color:whitesmoke" ;>Confirm</a>
                </td>
                <?php
                ?>
                <td>
