...
<body style="background-color:#e8eff4">
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="border border-2 border-dark rounded " style="margin-right:4%;margin-left:4%;background-color:white">
                <br>
        ...
        <div class="col">
            ...
            <div class="border border-2 border-dark rounded " style="margin-right:4%;margin-left:4%;background-color:white">
                ...
                <?php
                $fetchimage = "SELECT * FROM tlb_proof where cid = $ids";
                $fetchimageresult = mysqli_query($con, $fetchimage);
                $data_fetchimageresult = mysqli_fetch_assoc($fetchimageresult);

                // echo 
                $my = $data_fetchimageresult["id_proof_pic"];
                // echo 
                $father = $data_fetchimageresult["father"];
                // echo 
                $mother = $data_fetchimageresult["mother"];
                ...
                <div class="col">
                    <center>
                        <img class="rounded" width="90%" height="66%" src="image_upload/images/<?php echo $my; ?>" alt="" id="ProductImg">
                    </center>
                </div>
                ...
                <center>
                            ...
                            ?><br>
                                <div class=" small-img-row">
                                    <div class="small-img-col">
                                        <img style="border-radius:5px" width="100px" height="100px" src="image_upload/images/<?php echo $my; ?>" alt="" class="small-img">
                                        <img style="border-radius:5px" width="100px" height="100px" src="image_upload/images/<?php echo $father ?>" alt="" class="small-img">
                                        <img style="border-radius:5px" width="100px" height="100px" src="image_upload/images/<?php echo $mother ?>" alt="" class="small-img">
                    ...
                    <?php
                    $fetch_proof_status = "SELECT proof_status FROM status where cid = $ids";
                    ...
                    ?>
                        ...
                        <form name="profile" method="POST" action="kyc_approve.php">
                            <input type="hidden" name="idzz" id="idzz" value=" <?= $ids; ?> " />

                            <input type="submit" value="Approve" class="btn btn-outline-primary " />
                        </form>

                        <form name="profile" method="POST" action="kyc_reject.php">
                            <input type="hidden" name="idzz" id="idzz" value=" <?= $ids; ?> " />
                    ...
                    ?>
                        <input type="submit" readonly value="Rejected" class="btn btn-outline-danger " style="margin-bottom:17px" />
                    ...
                    ?>
                        ...
                        <input type="submit" readonly value="Approved" class="btn btn-outline-primary " style="margin-bottom:17px" />
