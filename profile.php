...
<body style="background-color:#e8eff4">
    ...
    <br><br><br><br><br><br>
    <div class="container" style="border:1px solid blue;background-color:white;border-radius: 5px;">

        <br>
        <center style="color:red">Profile Details</center><br>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" readonly class="form-control" id="mail" name="mail" value="<?php echo $rowbasic["email"] ?>" required />
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="dob" name="dob" max="<? echo $data2 ?>" required />
                            </div>
                        </div>
                        <div class="col">
